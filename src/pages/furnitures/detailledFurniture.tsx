    ...
    return (
      <div className="flex items-start gap-3 p-3 bg-red-50 rounded-lg border border-red-200">
        ...
        <div className="flex-1">
          <h4 className="font-medium text-red-700">Ressource introuvable</h4>
          <p className="text-xs text-red-600 mt-1">ID: {idRessource}</p>
        </div>
  ...
  return (
    <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-lg border border-orange-200">
      ...
      <div className="flex-1">
        ...
        <Button
            onClick={() => navigate(`/ressources/${resource._id}`)}
        >
            {">"}
        </Button>
      </div>
...
export const DetailledFurniture = () => {
  ...
  if (!furniture) {
    return (
      <div className="space-y-4 px-4 lg:px-6">
        <div className="text-center py-8">
          <p className="text-lg text-muted-foreground">Meuble non trouvé</p>
        </div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            <Badge
              variant={
                furniture.status === "ready_to_sell" ? "default" : "secondary"
              }
              className={
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold">Ressources Nécessaires</h3>
            </div>
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {furniture.ressources && furniture.ressources.length > 0 ? (
                ...
                <div className="text-center py-4 text-muted-foreground">
                  ...
                  <p className="text-sm">Aucune ressource nécessaire</p>
                </div>
              )}
            </div>
          </div>
